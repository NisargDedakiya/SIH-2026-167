"""
Change Description Tool.
Transforms detected bi-temporal changes, spatial coverage metrics, and region distributions
into structured natural-language narratives.
"""
...
class ChangeDescriptionTool(AnalysisTool):
    """
    Standardized AnalysisTool wrapper for bi-temporal scene change description.
    """

    def __init__(self):
        self.name = "change_description"
        self.version = "0.1.0"
        self.task = "CHANGE_ANALYSIS"
        self.description = (
            "Generates comprehensive natural-language change summaries and spatial distribution narratives "
            "between verified bi-temporal remote-sensing images."
        )
        ...
        self.optional_parameters = {
            "pair_id": None,
            "query": "Describe the major changes between the two dates.",
        }
    ...
    async def execute(
        ...
        query = parameters.get("query") or input_context.get("query") or "Describe the major changes between the two dates."
