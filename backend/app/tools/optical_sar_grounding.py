"""
Optical-SAR Cross-Modal Spatial Grounding Tool.
Localizes and extracts spatial bounding regions jointly corroborated by Optical and SAR evidence.
"""
...
class OpticalSARGroundingTool(AnalysisTool):
    """
    Standardized AnalysisTool wrapper for Optical-SAR Cross-Modal Grounding.
    """

    def __init__(self):
        self.name = "optical_sar_grounding"
        self.version = "1.0.0"
        self.task = "CROSS_MODAL_ANALYSIS"
        self.description = (
            "Detects, outlines, and bounds spatial regions of interest jointly supported "
            "by optical spectral contrast and SAR radar scattering mechanisms."
        )
        ...
        self.optional_parameters = {
            "query": "Highlight the regions supported by both optical and SAR imagery.",
        }
    ...
    async def execute(
        ...
        query = parameters.get("query") or input_context.get("query") or "Highlight the regions supported by both optical and SAR imagery."
